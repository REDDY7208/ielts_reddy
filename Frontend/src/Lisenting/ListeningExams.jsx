...
const ListeningExams = ({ testId }) => {
    ...
    const videoRef = React.useRef(null); // Ref for video element
    ...
    const handleStartNow = async () => {
        ...
        try {
            ...
            const startMonitoringResponse = await fetch('https://ieltsgenai.com/start_monitoring', {
            ...
            if (startMonitoringResponse.ok) {
                ...
                startVideoMonitoring(); // Start video monitoring
    ...
    const handleSubmit = async () => {
        ...
        const baseSubmitURL = "https://ieltsgenai.com/submits";

        try {

            const stopMonitoringResponse = await fetch('https://ieltsgenai.com/stop_monitoring', {
