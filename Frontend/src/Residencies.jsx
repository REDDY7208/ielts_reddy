...
//         const checkPlanResponse = await fetch(`https://ieltsgenai.com/check_plan_status?user_id=${user_id}`);
...
//         try {
//             // Create an order
//             const orderResponse = await fetch('https://ieltsgenai.com/create_order', {
//                 method: 'POST',
//                 headers: {
...
//                     fetch('https://ieltsgenai.com/payment_success', {
//                         method: 'POST',
//                         headers: {
//                             'Content-Type': 'application/json',
//                         },
    ...
    const handleCardClick = (plan) => {
        if (!isUserLoggedIn()) {
            notification.warning({
                ...
                description: 'Sorry, please log in to buy the plan.',
            });
            return;
        }
