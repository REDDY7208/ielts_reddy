  ...
  return (
    <nav className="navbar">
      ...
      <div className="navbar-links">
        ...
        <p className="navbar-link"><Link to="/Auth" className='link' onClick={toggleSidebar}>Register your Face</Link></p>
      ...
      {isSidebarVisible && (
        <div className="sidebar">
          ...
          <p className="sidebar-link"><Link to="/Auth" className='link' onClick={toggleSidebar}>Register your Face</Link></p>
