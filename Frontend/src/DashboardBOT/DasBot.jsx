...
function Dasbot() {
    ...
    const greetUser = () => {
        const greeting = "Hi, I am IELTSGenie. How can I help you today? I will be your learning tutor.";
    ...
    const getAnswerFromAPI = (question, callback) => {
        fetch('https://ieltsgenai.com/ask', {
            method: 'POST',
            headers: {
    ...
    return (
        <div className="dasbot-container">
            <div className="dasbot-header">
                ...
                <p style={{
                    color:'white'
                }}>Hii My name is IELTSGenie.<br></br> How Can I help you?</p>
            </div>
